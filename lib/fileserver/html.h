...
<body>
  <div style="text-align: center;">
    <h1 style="background-color: #252525; color: #ffffff;">SMARTMETER DATA LOGS</h1>
    <p>Free Storage: <span id="freespiffs" style="color:blue;font-weight:bold;">%FREESPIFFS%</span> | Used Storage: <span id="usedspiffs" style="color:blue;font-weight:bold;">%USEDSPIFFS%</span> | Total Storage: <span id="totalspiffs" style="color:blue;font-weight:bold;">%TOTALSPIFFS%</span></p>
    <p>
    <button onclick="logoutButton()">Logout</button>
    <button onclick="rebootButton()">Restart</button>
...
const char logout_html[] = R"rawliteral(
<!DOCTYPE HTML>
<html lang="en">
<head>
  <meta name="viewport" content="width=device-width, initial-scale=1">
